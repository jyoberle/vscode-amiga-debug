...
BOOL open_edit_window(struct DiskObject *dobj, char *name)
{
	...
	DoMethod(lv_edit,				MUIM_Notify,	MUIA_Listview_SelectChange,	TRUE,		app,	2,	MUIM_Application_ReturnID,	ID_EDIT_LV_ACTIVE	);
...
SAVEDS ASM char *tools_list_confunc(
	REG(a0, UNUSED struct Hook *hook),
	REG(a2, UNUSED APTR mem_pool),
...
static struct Hook tools_list_conhook = {
	{NULL, NULL},
	(void *)tools_list_confunc,
	NULL, NULL
};


SAVEDS ASM LONG tools_list_desfunc(
	REG(a0, UNUSED struct Hook *hook),
	REG(a2, UNUSED APTR mem_pool),
	REG(a1, char *line))
{
...
static struct Hook tools_list_deshook = {
	{NULL, NULL},
	(void *)tools_list_desfunc,
	NULL, NULL
};


SAVEDS ASM LONG tools_list_dspfunc(
	REG(a0, UNUSED struct Hook *hook),
	REG(a2, char **array),
	REG(a1, char *line))
{
...
static struct Hook tools_list_dsphook = {
	{NULL, NULL},
	(void *)tools_list_dspfunc,
	NULL, NULL
};


SAVEDS ASM LONG tools_list_cmpfunc(
	REG(a0, UNUSED struct Hook *hook),
	REG(a2, char *line1),
	REG(a1, char *line2))
{
...
static struct Hook tools_list_cmphook = {
	{NULL, NULL},
	(void *)tools_list_cmpfunc,
	NULL, NULL
};
...
SAVEDS ASM APTR select_rxfunc(
	REG(a0, UNUSED struct Hook *hook),
	REG(a2, UNUSED Object *appl),
	REG(a1, ULONG *arg))
{
	char *pattern;
...
static const struct Hook select_rxhook = {
	{NULL, NULL},
	(void *)select_rxfunc,
	NULL,NULL
};
...
int main(UNUSED int argc, UNUSED char *argv[])
{
	...
	app = ApplicationObject,
		...
		MUIA_Application_Version,			"$VER: WbMan 0.43 (07.02.2009)",
		MUIA_Application_Copyright,		"(c) 1993 Klaus Melchior",
	...
	DoMethod(lv_tools,		MUIM_Notify,	MUIA_Listview_DoubleClick,	TRUE,	app,	2,	MUIM_Application_ReturnID,	ID_EDIT			);
	DoMethod(lv_tools,		MUIM_Notify,	MUIA_Listview_SelectChange,	TRUE,	app,	2,	MUIM_Application_ReturnID,	ID_LV_ACTIVE	);
