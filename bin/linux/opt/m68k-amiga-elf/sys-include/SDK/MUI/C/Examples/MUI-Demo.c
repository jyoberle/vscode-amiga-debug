...
**          --------------------------------------
**
**             written 1992-98 by Stefan Stuntz
**
...
struct NewMenu Menu[] =
{
	{ NM_TITLE, (char *)"Project"  ,NULL       ,0,0,(APTR)0            },
	{ NM_ITEM , (char *)"About..." ,(char *)"?",0,0,(APTR)ID_ABOUT     },
	{ NM_ITEM , NM_BARLABEL        ,NULL       ,0,0,(APTR)0            },
	{ NM_ITEM , (char *)"Quit"     ,(char *)"Q",0,0,(APTR)MUIV_Application_ReturnID_Quit },
...
*/
	...
	AP_Demo = ApplicationObject,
		...
		MUIA_Application_Version       , "$VER: MUI-Demo 20.169 (30.10.2014)",
