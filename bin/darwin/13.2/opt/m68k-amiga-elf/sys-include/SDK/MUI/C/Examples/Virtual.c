	...
	APTR obj = ScrollgroupObject,
		...
		MUIA_Scrollgroup_Contents, VGroupV, VirtualFrame,
			...
			Child, ColGroup(2), GroupFrame,
				...
				Child, Label1("Gauge:"), Child, GaugeObject, GaugeFrame, MUIA_Gauge_Current, 66, MUIA_Gauge_Horiz, TRUE,
					MUIA_Gauge_FullImage, "2:rffaa33",
					End,
				Child, Label1("Gauge:"), Child, GaugeObject, GaugeFrame, MUIA_Gauge_Current, 66, MUIA_Gauge_Horiz, TRUE,
					MUIA_Gauge_FullImage, "2:r00ff00",
					MUIA_Background, "2:r0000ff",
					End,
...
int main(UNUSED int argc, UNUSED char *argv[])
{
	...
	app = ApplicationObject,
		...
		MUIA_Application_Version    , "$VER: VirtualDemo 20.178 (07.02.2009)",
