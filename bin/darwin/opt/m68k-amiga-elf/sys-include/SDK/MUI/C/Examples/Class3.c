...
int main(UNUSED int argc, UNUSED char *argv[])
{
	...
	app = ApplicationObject,
		...
		MUIA_Application_Version    , "$VER: Class3 20.166 (13.01.2015)",
		MUIA_Application_Copyright  , "(C) 1992-2006 Stefan Stuntz, 2015 Thore Böckelmann",
		MUIA_Application_Author     , "Stefan Stuntz, Thore Böckelmann",
