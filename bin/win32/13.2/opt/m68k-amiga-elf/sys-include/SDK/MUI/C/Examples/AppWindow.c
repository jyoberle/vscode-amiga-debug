...
SAVEDS ASM LONG AppMsgFunc(REG(a0, UNUSED struct Hook *h), REG(a2, APTR obj), REG(a1, struct AppMessage **x))
{
	struct WBArg *ap;
...
int main(UNUSED int argc, UNUSED char *argv[])
{
	...
	app = ApplicationObject,
		...
		MUIA_Application_Version    , "$VER: AppWindowDemo 20.169 (07.02.2009)",
