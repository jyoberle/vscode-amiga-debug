...
SAVEDS ASM void CopyFunc(REG(a0, UNUSED struct Hook *h), REG(a2, UNUSED APTR obj), REG(a1, APTR *lists))
{
...
SAVEDS ASM void MoveFunc(REG(a0, UNUSED struct Hook *h), REG(a2, UNUSED APTR obj), REG(a1, APTR *lists))
{
	struct FileInfoBlock *fib;
	LONG id = -1;
...
SAVEDS ASM void DeleteFunc(REG(a0, UNUSED struct Hook *h), REG(a2, UNUSED APTR obj), REG(a1, APTR *lists))
{
	struct FileInfoBlock *fib;
	LONG id = -1;
...
{
	{ "Copy"  , 'c', { { NULL,NULL },(VOID *)CopyFunc  ,NULL,NULL }},
	{ "Move"  , 'm', { { NULL,NULL },(VOID *)MoveFunc  ,NULL,NULL }},
	{ "Delete", 'd', { { NULL,NULL },(VOID *)DeleteFunc,NULL,NULL }},
};
...
int main(UNUSED int argc, UNUSED char *argv[])
{
	...
	app = ApplicationObject,
		...
		MUIA_Application_Version    , "$VER: MultiSel 20.165 (07.02.2009)",
